...
from libfjordweb.background_worker import process_supplied_data
from libfjordweb.celery import CeleryInspector
from libfjordweb.models import SuppliedData
from libfjordweb.process.utils import get_tasks
...
class ExploreDataView(View):
    ...
    error_template = "libfjordweb/error.html"
    explore_template = None
    processing_template = "libfjordweb/processing.html"
...
def handler500(request):
    ...
    t = loader.get_template("libfjordweb/500.html")
